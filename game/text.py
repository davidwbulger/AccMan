...
class TextGroup(object):
    ...
    def setupText(self):
        ...
        self.alltext[READYTXT] = Text("READY", YELLOW, 11.75*TILEWIDTH, 20*TILEHEIGHT, size, visible=False)
        self.alltext[PAUSETXT] = Text("PAUSED", YELLOW, 11.125*TILEWIDTH, 20*TILEHEIGHT, size, visible=False)
